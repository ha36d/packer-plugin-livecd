...
// Run with: PACKER_ACC=1 go test -count 1 -v ./datasource/livecd/data_acc_test.go  -timeout=120m
func TestAcclivecdDatasource(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "livecd_datasource_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
